...
{
  this->HideResliceCursorActor = false;
...
void vtkResliceCursorActor::UpdateViewProps(vtkViewport *v)
{
  ...
  if (!this->HideResliceCursorActor)
  {
  ...
  {
      this->CursorThickSlabActor[axis1]->SetVisibility(0);
      this->CursorThickSlabActor[axis2]->SetVisibility(0);
      this->CursorThickSlabActor[axisNormal]->SetVisibility(0);
      this->CursorCenterlineActor[axis1]->SetVisibility(0);
      this->CursorCenterlineActor[axis2]->SetVisibility(0);
      this->CursorCenterlineActor[axisNormal]->SetVisibility(0);

      this->CursorThickSlabActor[axis1]->GetProperty()->SetEdgeVisibility(0);
      this->CursorThickSlabActor[axis2]->GetProperty()->SetEdgeVisibility(0);
      this->CursorThickSlabActor[axisNormal]->GetProperty()->SetEdgeVisibility(0);
      this->CursorCenterlineActor[axis1]->GetProperty()->SetEdgeVisibility(0);
      this->CursorCenterlineActor[axis2]->GetProperty()->SetEdgeVisibility(0);
      this->CursorCenterlineActor[axisNormal]->GetProperty()->SetEdgeVisibility(0);
  }
}
